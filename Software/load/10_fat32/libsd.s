...
SPI_CS   = %00010000     ; CS
SPI_SCK  = %00001000     ; SCK
SPI_MOSI = %00000100     ; DI
SPI_MISO = %00000010     ; DO

VIA2_PORTA  = __VIA2_START__ + $1	
VIA2_DDRA   = __VIA2_START__ + $3

        .zeropage
zp_send_cmd_bytes:      .res 2      ; holds a ptr to the command data bytes.
zp_sd_address:          .res 2      ; 16bit address ptr for page buffer
        .bss
